...
import Navegador2 from "./NavIni";
import Navegador3 from "./Sola"; // El segundo componente de navegación
...
export default function App() {
  ...
  return (
    <div className={darkMode ? "dark-mode" : "light-mode"}>
      ...
      <Navegador3  toggleDarkMode={toggleDarkMode} darkMode={darkMode} />
    </div>
  );
}
